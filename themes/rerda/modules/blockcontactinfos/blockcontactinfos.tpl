...
<section id="block_contact_infos" class="footer-block col-xs-12 col-sm-4">
	<div>
        ...
        <ul class="toggle-footer">
            ...
            {if $blockcontactinfos_phone != ''}
            	<li>
            		...
            		Tel/Fax: <span>{$blockcontactinfos_phone|escape:'html':'UTF-8'}</span>
            	</li>
            {/if}
        ...
        <p>{include file="$tpl_dir./seguinos-social.tpl"}</p>
        <p class="text-uppercase">&copy; {'Y'|date} Rerda - Todos los derechos reservados</p>
    </div>
</section>
<!-- /MODULE Block contact infos -->
