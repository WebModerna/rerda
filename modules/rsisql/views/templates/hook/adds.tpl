...
<div class="bootstrap panel">
	<div class="panel-heading">
		<i class="icon-database"></i> {l s="Database"}
	</div>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/_RjBi93JGWk?rel=0&amp;showinfo=0" frameborder="0" allowfullscreen></iframe>
</div>
